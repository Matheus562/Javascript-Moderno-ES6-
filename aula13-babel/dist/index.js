...
var average = function average() {
  ...
  var sum = numbers.reduce(function (accum, num) {
    return accum + num;
  }, 0); //reduce soma todos os elementos do array. accum = acumulador se iniciando com 0, num = numero atual
  return sum / numbers.length;
};
console.log("M\xE9dia Aritim\xE9tica Simples: ".concat(average(3, 6, 10, 9))); //Template literals
...
var median = function median() {
  ...
  var orderedNumbers = [].concat(numbers).sort(function (a, b) {
    return a - b;
  }); // sort() organiza o array de forma crescente
  var middle = Math.floor(orderedNumbers.length / 2); //floor retorna o menor número inteiro dentre o número (orderedNumbers.length / 2).
...
console.log("Mediana: ".concat(median(15, 14, 9, 7, 3)));
